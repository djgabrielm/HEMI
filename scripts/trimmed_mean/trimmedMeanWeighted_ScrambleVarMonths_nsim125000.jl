...
savepath = datadir("Trimmed_Mean", "Weighted", "ScrambleVarMonths","nsim125000")
...
plot1 = heatmap(rango_inf,
            rango_sup, 
            (1 ./ MATRIX), 
            title  = L"MSE^{-1} \ para \ media \ truncada \  ponderada \ con \ ScrambleVarMonths \ y \ N_{sim} = 125,000 ",
            xlabel = L"\ell_1", 
            ylabel = L"\ell_2",
            size   = (600,400),
            titlefontsize = 10
...
cd(plotsdir("Trimmed_Mean", "Weighted", "ScrambleVarMonths", "nsim125000"))

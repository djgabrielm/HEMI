...
save_dirs = [joinpath("results","InflationTrimmedMeanEq","Esc-B2018"),
             joinpath("results","InflationTrimmedMeanWeighted", "Esc-B2018")
]
...
grid_optim(dir_list[1], gtdata_eval, 10_000, 20, :mse; save_dir = save_dirs[1])
grid_optim(dir_list[2], gtdata_eval, 10_000, 20, :mse; save_dir = save_dirs[2])
...
plotpath = joinpath("docs", "src", "eval", "EscB2018", "images", "trimmed_mean")

...
grid_batch(gtdata,InflationTrimmedMeanEq, ResampleScrambleVarMonths(), 
            TrendRandomWalk(),1_000, 45:75, 70:100,InflationTotalRebaseCPI(36,2),
            Date(2018,12); save_dir = save_dirs[1]
)
            
grid_batch(gtdata,InflationTrimmedMeanWeighted, ResampleScrambleVarMonths(), 
            TrendRandomWalk(),1_000, 5:35, 70:100,InflationTotalRebaseCPI(36,2),
            Date(2018,12); 
...
dir_list = [joinpath(save_dirs[1],"MTEq_SVM_RW_Rebase36_N1000_2018-12"), 
            joinpath(save_dirs[2],"MTW_SVM_RW_Rebase36_N1000_2018-12")
]
...
Plots.svg(p, joinpath(plotpath, "trayectorias_MT_2018"))

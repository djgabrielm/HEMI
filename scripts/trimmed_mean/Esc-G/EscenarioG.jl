...
save_dirs = [joinpath("results","InflationTrimmedMeanEq","Esc-G"),
             joinpath("results","InflationTrimmedMeanWeighted","Esc-G")
]
...
grid_optim(dir_list[1], gtdata_eval, 10_000, 20, :absme; save_dir = save_dirs[1])
grid_optim(dir_list[2], gtdata_eval, 10_000, 20, :absme; save_dir = save_dirs[2])
...
plotpath = joinpath("docs", "src", "eval", "EscG", "images", "trimmed_mean")
